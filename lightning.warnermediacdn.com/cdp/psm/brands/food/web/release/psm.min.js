var psmMgrConfig = {
    psmBrand: "food",
    psmSubBrand: "food.com",
    psmBootstrapVersion: "web/release/3.8.0",
    psmHost: "warnermediacdn.com"
};
psmMgrConfig.psmEnvironment = "release";
psmMgrConfig.psmBrandToken = "food";
var psmMgr = {
    ...
    initPsm: function() {
        ...
        WM.PSM.initPsm({ ...psmMgrConfig.psmAppId && {
                appId: psmMgrConfig.psmAppId
            },
